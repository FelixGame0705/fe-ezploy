...
import { Building2, Lightbulb, Wrench, MapPin, Mail, Phone } from "lucide-react";
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <div className="mt-8 flex justify-center">
            <div className="relative h-56 w-full max-w-3xl overflow-hidden rounded-2xl shadow-xl">
              <Image
        ...
        <div className="mt-16 space-y-12">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 p-8 shadow-xl dark:from-blue-900/20 dark:to-indigo-900/20">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="flex items-start gap-4 rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
                <div className="rounded-full bg-yellow-100 p-3 dark:bg-yellow-900/30">
                  <Lightbulb className="h-6 w-6 text-yellow-600 dark:text-yellow-400" />
                </div>
                <div>
                  <h4 className="mb-2 font-semibold text-gray-900 dark:text-white">
                    {validLocale === 'vi' ? 'Chuyển đổi số' : 'Digital Transformation'}
                  </h4>
                  <p className="text-gray-700 dark:text-gray-300">
                    {t.about.focus.digital}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
                ...
                <div>
                  <h4 className="mb-2 font-semibold text-gray-900 dark:text-white">
                    {validLocale === 'vi' ? 'Đơn giản hóa' : 'Simplification'}
                  </h4>
                  <p className="text-gray-700 dark:text-gray-300">
                    {t.about.focus.simplify}
                  </p>
                </div>
              </div>
            </div>
